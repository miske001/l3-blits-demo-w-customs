      ...
      rails: [
        {
          ...
          items: [
            { color: '#ef4444', width: 400, height: 400, type: Item, isLeaf: true },
            { color: '#f97316', width: 400, height: 400, type: Item, isLeaf: true },
            { color: '#84cc16', width: 400, height: 400, type: Item, isLeaf: true },
            { color: '#ef4444', width: 400, height: 400, type: Item, isLeaf: true },
            { color: '#f97316', width: 400, height: 400, type: Item, isLeaf: true },
            { color: '#84cc16', width: 400, height: 400, type: Item, isLeaf: true },
            { color: '#ef4444', width: 400, height: 400, type: Item, isLeaf: true },
        ...
        }, */
        {
          ...
          type: HorizontalContainer,
          items: [
            { color: '#10b981', width: 200, height: 300, type: Item, isLeaf: true },
            { color: '#06b6d4', width: 200, height: 300, type: Item, isLeaf: true },
            { color: '#3b82f6', width: 200, height: 300, type: Item, isLeaf: true },
            { color: '#10b981', width: 200, height: 300, type: Item, isLeaf: true },
            { color: '#06b6d4', width: 200, height: 300, type: Item, isLeaf: true },
            { color: '#3b82f6', width: 200, height: 300, type: Item, isLeaf: true },
            { color: '#10b981', width: 200, height: 300, type: Item, isLeaf: true },
        ...
        // },
        {
          ...
          type: HorizontalContainer,
          items: [
            { color: '#10b981', width: 200, height: 200, type: Item, isLeaf: true },
            { color: '#06b6d4', width: 200, height: 200, type: Item, isLeaf: true },
            { color: '#06b6d4', width: 200, height: 200, type: Item, isLeaf: true },
            { color: '#06b6d4', width: 200, height: 200, type: Item, isLeaf: true },
          ],
        },
        {
          ...
          rowH: 200,
          type: HorizontalContainer,
          items: [{ color: '#10b981', width: 200, height: 200, type: Item, isLeaf: true }],
        },
        // {
        //   title: 'Rejl broj 4',
        //   rowH: 800,
